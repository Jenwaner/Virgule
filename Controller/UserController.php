...
class UserController extends AbstractController
{
   /**
     ...
     */
    public function shoppings(ShoppingRepository $shoppingRepository, CcardRepository $ccardRepository): Response
    {
        $user = $this->getUser();
    ...
    public function newComment(Request $request, $id): Response
    {
        ...
        if ($form->isSubmitted() && $this->isCsrfTokenValid('comment', $submittedToken)) {
            ...
            $this->addFlash('success', 'Your review has been sent successfuly');
    ...
    public function newShopping(Request $request, $pid, ProductRepository $productRepository): Response
    {
        ...
        return $this->render('user/showbuyshopping.html.twig', [
            'shopping' => $shopping,
            'product' => $product,
            'total' => $total,
            'amount' => $amount,
